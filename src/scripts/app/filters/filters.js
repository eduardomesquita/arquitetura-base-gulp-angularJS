(function () {
    ...
    angular.module('sandbox-app').filter('cep', function() {
    ...
    angular.module('sandbox-app').filter('cpfcnpj', function() {
        return function(input){
            if (!input) {
                return;
    ...
    angular.module('sandbox-app').filter('telefonebr', function() {
        return function (input){
            if (!input) {
    ...
    angular.module('sandbox-app').filter('dataformatada', function() {
        return function (input){
            if(!input){
                return ;
            }
    ...
    angular.module('sandbox-app').filter('simNao', function () {
        return function (input) {
